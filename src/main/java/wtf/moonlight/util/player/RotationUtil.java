...
public class RotationUtil implements InstanceAccess {
    ...
    public static void setRotation(float[] rotation, final MovementCorrection correction) {
        RotationUtil.currentRotation = applyGCDFix(serverRotation, rotation);
    ...
    public static void setRotation(float[] rotation, String mode, final MovementCorrection correction, float minYawRotSpeed, float maxYawRotSpeed, float minPitchRotSpeed, float maxPitchRotSpeed,float bezierP0,float bezierP1,float bezierP2,float bezierP3,float bezierP4,float bezierP5,float bezierP6,float bezierP7,float elasticity,float dampingFactor, boolean smoothlyReset) {
        ...
        cachedMode = mode;
        RotationUtil.bezierP0 = bezierP0;
        RotationUtil.bezierP1 = bezierP1;
        RotationUtil.bezierP2 = bezierP2;
        RotationUtil.bezierP3 = bezierP3;
        RotationUtil.bezierP4 = bezierP4;
        RotationUtil.bezierP5 = bezierP5;
        RotationUtil.bezierP6 = bezierP6;
        RotationUtil.bezierP7 = bezierP7;
        RotationUtil.elasticity = elasticity;
        RotationUtil.dampingFactor = dampingFactor;
    ...
    public static float getRotationDifference(final Entity entity) {
        float[] target = RotationUtil.getRotations(entity.posX, entity.posY + entity.getEyeHeight(), entity.posZ);
    ...
    public static float getRotationDifference(final Entity entity, final Entity entity2) {
        float[] target = RotationUtil.getRotations(entity.posX, entity.posY + entity.getEyeHeight(), entity.posZ);
        float[] target2 = RotationUtil.getRotations(entity2.posX, entity2.posY + entity2.getEyeHeight(), entity2.posZ);
    ...
    public static boolean isLookingAtEntity(final float[] rotation,final double range) {
        return isLookingAtEntity(RotationUtil.rayCast(rotation,range).entityHit,rotation,range);
    }

    public static boolean isLookingAtEntity(Entity target, final double range) {
        return isLookingAtEntity(target, RotationUtil.serverRotation,range);
    }
    ...
    public static MovingObjectPosition rayCast(final float[] rots, final double range, final float partialTicks) {
        ...
        if (entity != null && mc.theWorld != null)
        {
            ...
            Vec3 vec31 = entity.getLookCustom(RotationUtil.serverRotation[0], RotationUtil.serverRotation[1]);
