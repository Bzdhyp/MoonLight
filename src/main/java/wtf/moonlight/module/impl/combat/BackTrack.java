...
public class BackTrack extends Module {
    private final ListValue esp = new ListValue("Mode", new String[]{"Off", "Box"}, "Box", this);
    ...
    private final ListValue activeMode = new ListValue("Active Mode", new String[]{"Hit", "Not Hit","Always"}, "Always", this);
        ...
        if (event.isPost()) {
            ...
            if (on) {
                if (shouldActive(target)) {
                    ping = MathUtils.randomizeInt(minMS.getValue(), maxMS.getValue());
