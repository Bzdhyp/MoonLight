...
public class AutoRod extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (getModule(Scaffold.class).isEnabled() || getModule(KillAura.class).target != null || isEnabled(Stuck.class) || !mc.thePlayer.canEntityBeSeen(target) || mc.thePlayer.isUsingItem() || !RenderUtil.isBBInFrustum(target.getEntityBoundingBox())) {
            return;
        }
