...
public class Annoy extends Module {
    ...
    public final ListValue moveFixMode = new ListValue("Movement", new String[]{"Silent", "Strict"}, "Silent", this, moveFix::get);
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (customRotationSetting.get()) {
            RotationUtils.setRotation(rots,smoothMode.getValue(),moveFix.get() ? moveFixMode.is("Strict") ? MovementCorrection.STRICT : MovementCorrection.SILENT : MovementCorrection.OFF, minYawRotSpeed.getValue(), maxYawRotSpeed.getValue(), minPitchRotSpeed.getValue(), maxPitchRotSpeed.getValue(),
                    bezierP0.getValue(),
                    bezierP1.getValue(),
                    bezierP2.getValue(),
                    bezierP3.getValue(),
