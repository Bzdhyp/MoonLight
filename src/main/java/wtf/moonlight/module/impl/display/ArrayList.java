 ...
 */
@ModuleInfo(name = "ArrayList", category = ModuleCategory.Display)
public class ArrayList extends wtf.moonlight.module.Module {
    ...
    public SliderValue sb = new SliderValue("FontCount", 1.0f, -20.0f, 20.0f,0.1f, this);
    ...
    public ListValue backgroundmod = new ListValue("BackGroundMod", new String[]{"Rect", "Round"}, "Rect", this, () -> background.get());
