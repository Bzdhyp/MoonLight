...
public class FireFlies extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.thePlayer.ticksExisted % (int) (this.spawnDelay.getValue() + 1.0f) == 0) {
            this.FIRE_PARTS_LIST.add(new FireFlies.FirePart(this.generateVecForPart(10.0, 4.0), maxAliveTime.getValue()));
            this.FIRE_PARTS_LIST.add(new FireFlies.FirePart(this.generateVecForPart(6.0, 5.0), maxAliveTime.getValue()));
        }
    }
    ...
    private class FirePart {
        ...
        public void updatePart() {
            ...
            if (this.getTimePC() >= 1.0f || animation.timerUtils.hasTimeElapsed(maxAliveTime.getValue())) {
